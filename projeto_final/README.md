...
## 🥋 Sobre o Projeto
Uma aplicação interativa 3D dedicada a kimonos de Jiu-Jitsu. O projeto simula um ambiente virtual onde o usuário pode visualizar modelos em uma vitrine realista, inspecioná-los em 360 graus e personalizar cada parte do traje.

O projeto é focado nos conceitos apresentados nas aulas de computação gráfica:
...
* **Pipelines de Renderização (Shaders GLSL):** Criação de um Fragment Shader otimizado do zero para lidar com diferentes materiais numa única passagem.
...
Para explorar a loja:
1. Clique no botão **"Selecionar Produtos"** localizado embaixo do modelo desejado na vitrine.
2. Utilize o painel lateral para misturar cores das peças (vagui, calça e faixa) e visualizar em tempo real as diferentes marcas.
3. Personalize seu nome para gerar um bordado customizado dinâmico nas costas do kimono!
4. Use o slider de **Tempo de Uso** para simular desgaste e sujeira orgânica na textura do tecido.
